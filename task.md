...
- [ ] **Settings — currency display** — default currency preference saves to settings.json and is used for new expenses, but existing expense display still reads stored currency per-expense. Overview totals assume single currency.
